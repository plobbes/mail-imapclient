...
is 993 if Ssl L</Ssl> is true otherwise the default is 143, which is
the standard IMAP port.  Can be supplied with the L</new> method call
or separately by calling the L</Port> object method.
